...
/*
 * Greedy 1: elegir prefijos por mayor satisfacción por minuto.
 *
 * Idea:
 ...
 *       satisfacción_total / minutos_totales
...
int main() {
    ...
    for (int i = 0; i < n; ++i) {
        ...
        for (int len = 1; len <= q; ++len) {
            ...
            opt.ratio = static_cast<long double>(totalValue) / static_cast<long double>(prefT);
